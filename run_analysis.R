...
####Be sure to set your desired working directory prior to running this script!


#setInternet2(use = TRUE) #Insert this only if your Windows OS has problems with "https"
